  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 relative overflow-hidden">
        ...
        <Card className="relative w-full max-w-md overflow-hidden rounded-[2rem] border border-white/15 bg-white/95 p-8 text-center shadow-[0_24px_80px_rgba(15,23,42,0.35)] backdrop-blur-xl">
          ...
          <p className="mt-3 mb-8 text-slate-600 leading-relaxed">Please sign in to manage your settings</p>
